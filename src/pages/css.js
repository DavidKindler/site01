...
let sidebar = (
  <div className="fsl-docs-sidebar">
    <ul className="nav bs-docs-sidenav">
      ...
      <li>
        ...
        <ul className="nav">
          ...
          <li>
            <a href="#helper-classes-contextual-status">Contextual Status</a>
          </li>
          <li>
...
let htmlContent = (
      ...
      <div className="col-md-9" role="main">
        <div className="bs-docs-section">
          ...
          <article className="type-general">
            ...
            <p>
              Regional sites use the following font families. These are defined
              in the regional delta stylesheets.
            </p>
          ...
          <article className="type-headings">
            ...
            <section className="overview">
              ...
              <p>
                All headings use the "Lato" font family. Color values below are{" "}
                <a href="/#less-overview">less</a> variables. Please check the
                color palette for these values.
              </p>
            </section>
            <section className="bc-example">
              <h1>
                H1 Heading - 22px mobile screens - 26px &gt;larger than mobile
                <br />
                &lt;h1&gt; <span className="small">or</span> .h1
              </h1>
              <hr />
              <h2>
                H2 Heading - 20px mobile screens - 22px &gt;larger than mobile
                <br />
                &lt;h2&gt; <span className="small">or</span> .h2
              </h2>
              <hr />
              <h3>
                H3 Heading - 18px mobile screens - 20px &gt;larger than mobile
                <br />
                &lt;h3&gt; <span className="small">or</span> .h3
              </h3>
              <hr />
              <h4>
                H4 Heading - 16px mobile screens - 18px &gt;larger than mobile
                <br />
                &lt;h4&gt; <span className="small">or</span> .h4
              </h4>
              <hr />
              <h5>
                H5 Heading - 14px mobile screens - 16px &gt;larger than mobile
                <br />
  ...
  <h6>    h6. BaseCamp heading <small>Secondary text</small>  </h6>
          ...
          <article className="type-body-copy">
            ...
            <div className="highlight">
              <CodeBlock language={"jsx"} value={`<p class="intro">...</p>`} />
            </div>
          </article>
          ...
          <article className="type-emphasis">
            ...
            <p>
              ...
              parent. Heading elements receive their own <code>font-size</code>{" "}
              for nested <code>&lt;small&gt;</code> elements.
            </p>
            <p>
              You may alternatively use an inline element with{" "}
              <code>.small</code> in place of any <code>&lt;small&gt;</code>.
            </p>
            <div className="bc-example">
              <p className="small">
...
<p class="small">
    This line of text is meant to be treated as fine print.
            ...
            <p>
              ...
              <code>&lt;large&gt;</code> tag to set text at 115% the size of the
              parent.
            </p>
            <p>
              You may alternatively use an inline element with{" "}
              <code>.large</code> in place of any <code>&lt;large&gt;</code>.
            </p>
            <div className="bc-example">
              <p className="large">
            ...
            <div className="bs-callout bs-callout-info">
              ...
              <p>
                ...
                <code>&lt;i&gt;</code> in HTML5. <code>&lt;b&gt;</code> is meant
          ...
          <article className="type-lists">
            ...
            <div className="bs-callout bs-callout-info">
              ...
              <p>
                ...
                long to fit in the left column with <code>text-overflow</code>.
          ...
          <article className="colors-text">
            ...
            <div className="highlight">
              ...
              <p>
                ...
                <span className="nxp-orange-text">&nbsp;For Orange Text</span>
              </p>
              <p>
        ...
        <div className="bs-docs-section">
          ...
          <article className="tables-example">
            ...
            <p>
              ...
              <code>&lt;table&gt;</code>. It may seem super redundant, but given
          ...
          <article className="tables-striped">
            ...
            <div className="bs-callout bs-callout-danger">
              ...
              <p>
                Striped tables are styled via the <code>:nth-child</code> CSS
          ...
          <article className="tables-light">
            ...
            <p>
              Add <code>.table-head-light</code> for the table header to have a
              white background color and thicker bottom border.
            </p>
            <div className="bc-example">
          ...
          <article className="tables-condensed">
            ...
            <p>
              Add <code>.table-condensed</code> to make tables more compact by
              cutting cell top and bottom padding in half and removing bottom
              margin from <code>p</code> elements.
            </p>
            <div className="bc-example">
          ...
          <articles className="tables-combined">
            ...
            <p>
              You can combine table classes to change the the table style. For
              example, the table below combines <code>.table-head-light</code>,{" "}
              <code>table-striped</code>, and <code>table-bordered</code>.
            </p>
            <div className="bc-example">
          ...
          <article className="tables-responsive">
            ...
            <p>
              ...
              <code>.table-responsive</code> to make them scroll horizontally up
              to small devices (under 768px). When viewing on anything larger
        ...
        <div className="bs-docs-section">
          ...
          <article className="forms-example">
            ...
            <p>
              ...
              <code>width: 100%;</code> by default. Wrap labels and controls in{" "}
              <code>.form-group</code> for optimum spacing.
            </p>
            <div className="bc-example">
              <form role="form">
          ...
          <article className="forms-inline">
            ...
            <h2>Inline form</h2>
            <p>
              Add <code>.form-inline</code> to your <code>&lt;form&gt;</code>{" "}
            ...
            <div className="bs-callout bs-callout-danger">
              ...
              <p>
                ...
                BaseCamp. To use the inline form, you'll have to set a width on
            ...
            <div className="bs-callout bs-callout-warning">
              ...
              <p>
                ...
                hide the labels using the <code>.sr-only</code> class.
              </p>
            </div>
          ...
          <article className="forms-horizontal">
            ...
            <p>
              Use BaseCamp's predefined grid classes to align labels and groups
              of form controls in a horizontal layout by adding{" "}
              <code>.form-horizontal</code> to the form. Doing so changes{" "}
              <code>.form-group</code>s to behave as grid rows, so no need for{" "}
              <code>.row</code>.
            </p>
            <div className="bc-example">
          ...
          <article className="forms-control">
            ...
            <p>
              Examples of standard form controls supported in an example form
              layout.
            </p>
            ...
            <section className="forms-control-inputs">
              ...
              <div className="bs-callout bs-callout-danger">
                ...
                <p>
                  Inputs will only be fully styled if their <code>type</code> is
                  properly declared.
                </p>
              </div>
              <div className="bc-example">
            ...
            <section className="forms-control-checkbox">
              ...
              <div className="bc-example">
                <form role="form">
                  <div className="checkbox">
                    <label>
                      <input type="checkbox" value="" /> Option one is this and
            ...
            <section className="forms-control-inline-checkbox">
              ...
              <p>
                ...
                <code>.radio-inline</code> classes on a series of checkboxes or
          ...
          <article className="input-groups">
            ...
            <p>
              ...
              on both sides of any text-based <code>&lt;input&gt;</code>. Use{" "}
              <code>.input-group</code> with an <code>.input-group-addon</code>{" "}
              or <code>.input-group-btn</code> to prepend or append elements to
            ...
            >
              ...
              <p>
                Avoid using <code>&lt;select&gt;</code> elements here as they
                cannot be fully styled in WebKit browsers.
              </p>
              <p>
                Avoid using <code>&lt;textarea&gt;</code> elements here as their{" "}
                <code>rows</code> attribute will not be respected in some cases.
              </p>
            </div>
            <div
            ...
            >
              ...
              <p>
                ...
                <code>container: 'body'</code> to avoid unwanted side effects
                (such as the element growing wider and/or losing its rounded
                corners when the tooltip or popover is triggered).
              </p>
            </div>
            <div
              className="bs-callout bs-callout-warning"
            ...
            >
              ...
              <p>
                ...
                input groups. Instead, nest the input group inside of the form
                group or grid-related element.
              </p>
            </div>
            ...
            <section className="input-groups-sizing">
              ...
              <p>
                Add the relative form sizing classes <code>input-group-sm</code>{" "}
                or <code>input-group-lg</code> to the <code>.input-group</code>{" "}
                itself and contents within will automatically resize—no need for
                repeating the form control size classes on each element. No need
                to add a class for the default size.
              </p>
              <div className="bc-example">
          ...
          <article className="forms-control-static">
            ...
            <p>
              ...
              horizontal form, use the <code>.form-control-static</code> class
              on a <code>&lt;p&gt;</code>.
            </p>
            <div className="bc-example">
              <form className="form-horizontal" role="form">
          ...
          <article className="forms-control-focus">
            ...
            <div className="bs-callout bs-callout-info">
              ...
              <p>
                ...
                to demonstrate the <code>:focus</code> state on a{" "}
          ...
          <article className="forms-control-disabled">
            ...
            <p>
              ...
              the <code>&lt;fieldset&gt;</code> at once.
            </p>
            <div className="bs-callout bs-callout-warning">
              <h4>
            ...
            <div className="bs-callout bs-callout-danger">
              <h4>Cross-browser compatibility</h4>
              <p>
                While BaseCamp will apply these styles in all browsers, Internet
                Explorer 9 and below don't actually support the{" "}
                <code>disabled</code> attribute on a{" "}
                <code>&lt;fieldset&gt;</code>. Use custom JavaScript to disable
          ...
          <article className="forms-control-validation">
            ...
            <p>
              You can also add optional feedback icons with the addition of an
              extra class and the right icon.
            </p>
            <div className="bs-callout bs-callout-warning">
              ...
              <p>
                ...
                <a href="./components#forms-input-groups">input groups</a> with
                an add-on on the right. For inputs without labels, adjust the{" "}
                <code>top</code>value. For input groups, adjust the{" "}
                <code>right</code> value to an appropriate pixel value depending
                on the width of your addon.
              </p>
            </div>
            <div className="bc-example">
              <form role="form">
        ...
        <div className="bs-docs-section">
          ...
          <h2>Inline Links</h2>
          <p>
            Inline links are found within body copy, usually within a block or
            paragraph of text. These links are the standard text color,
            underlined, and change color to an aqua on hover.
          </p>
          <div className="bc-example">
            <p>
              Lorem ipsum dolor sit amet, <a href="#nogo">consectetur</a>{" "}
              adipisicing elit. Voluptas veritatis nostrum non quasi voluptatem
              impedit quis, id soluta? Ducimus magni eaque incidunt repellendus
              maiores quas unde vero eum, voluptates. Nam!
            </p>
          </div>
          <div className="highlight">
            <CodeBlock
          ...
          <article className="links-general">
            ...
            <h2>General links</h2>
            <p>
              When displaying a link that is not a call-to-action, but a visual
              indicator is needed, please use the <code>ext</code> class. This
              will provide a <code>newtab</code> or <code>PDF</code> icon after
              the link text. This class can be used on <code>button</code>s
              also, and will add the <code>newtab</code> icon after the button
              text.
            </p>
            <div className="bc-example">
              <ul className="list-unstyled nobullets">
                <li>
                  <a className="ext" href="/components.html" target="_blank">
                    Relative link
                  </a>
                </li>
                <li>
          ...
          <article className="links-ctas">
            ...
            <p>
              ...
              perform some specific action. This should be a single item, and
              the focus of the content that comes before. If there are multiple
              links, consider using basic links placed in a{" "}
              <code>&lt;ul class="list-unstyled"></code> or{" "}
              <code>&lt;ul class="list-inline"></code>.
            </p>
            <p>
              Standard call-to-action links are displayed as text links, and use
              a <code>cta</code> class. These differ from inline links, since
              they are not underlined and have a hover animation. These links
              also have a caret or <code>&gt;</code> symbol after the text. This
              icon changes on certain factors, such as if the link leaves the
              main site or references a PDF document.
            </p>
            <div className="bc-example">
        ...
        <div className="bs-docs-section">
          ...
          <article className="buttons-options">
            ...
            <p>
              ...
              button. If there are multiple buttons with equal importance they
              should all be the standard grey button color. If one action is
              most important, that button should be the orange button color with
              the others being button grey color.
            </p>
          ...
          <article className="buttons-disabled">
            ...
            <p>
              The utility class <code>.disabled</code> can be used for buttons
              and links. Buttons will look unclickable by fading them.
            </p>
            <p>
          ...
          <article className="buttons-tags">
            ...
            <div className="bs-callout bs-callout-warning">
              ...
              <p>
                ...
                that prevents us from setting the <code>line-height</code> of{" "}
                <code>&lt;input&gt;</code>-based buttons, causing them to not
        ...
        <div className="bs-docs-section">
          ...
          <article className="images-responsive">
            ...
            <p>
              ...
              addition of the <code>.img-responsive</code> class. This applies{" "}
              <code>max-width: 100%;</code> and <code>height: auto;</code> to
              the image so that it scales nicely to the parent element.
            </p>
            <div className="highlight">
              <CodeBlock
                language={"jsx"}
          ...
          <article className="images-shapes">
            ...
            <div className="bg-warning">
              <h4>Cross-browser compatibility</h4>
              <p>
                Keep in mind that Internet Explorer 8 lacks support for rounded
                corners.
              </p>
            </div>
            <br />
        ...
        <div className="bs-docs-section">
          ...
          <article className="helper-classes-contextual-status">
            ...
            <div className="bc-example">
              <h1>
                Page Title <span className="small text-updated">Updated</span>
              </h1>
              <h1>
                Page Title <span className="small text-archived">Archived</span>
              </h1>
              <h1>
              ...
              <h3>
                Subtitle <span className="small text-archived">Archived</span>
              </h3>
              <h3>
          ...
          <article className="helper-classes-floats">
            ...
            <p className="mb1">
              Often you may want to float an image in a certain direction for
              desktop or tablet views, but not for smaller devices. Use media
              breakpoint classes like<code>.float-lg-right</code>,{" "}
              <code>.float-md-right</code>, etc. at the breakpoint where you
              want the float to begin. Available are <code>.float-xs-*</code> =
              extra small, <code>.float-sm-*</code> = small,{" "}
              <code>.float-md-*</code> = medium and <code>.float-lg-*</code> =
              large. <code>.float-*-none</code> using any of the breakpoint
              codes is also available when you do not want a float to exist.
            </p>
            ...
            <div className="bs-callout bs-callout-warning">
              ...
              <p>
                ...
                <code>.navbar-left</code> or <code>.navbar-right</code> instead.{" "}
          ...
          <article className="helper-classes-show-hide">
            ...
            <p>
              ...
              <code>.show</code> and <code>.hidden</code> classes. These classes
              use <code>!important</code> to avoid specificity conflicts, just
              like the <a href="#helper-classes-floats">quick floats</a>. They
              are only available for block level toggling. They can also be used
              as mixins.
            </p>
            <p>
              <code>.hide</code> is available, but it does not always affect
              screen readers and is <strong>deprecated</strong> as of v3.0.1.
              Use <code>.hidden</code> or <code>.sr-only</code> instead.
            </p>
            <p>
              Furthermore, <code>.invisible</code> can be used to toggle only
              the visibility of an element, meaning its <code>display</code> is
          ...
          <article className="helper-classes-spacers">
            ...
            <h2>Spacers</h2>
            <p>
              A variety of classes to add margin or padding to an element. There
              are responsive and fixed size options available.
            </p>
            ...
            <p>
              ...
              <br />
              These classes provide em-based distance adjustments and work well
              for mainting a vertical rhythm across devices. They scale relative
              to the assigned font size. These should be used in most cases
              where spacing is needed.
            </p>
            <p>
              property: p = padding | m = margin
              <br /> direction: l = left | r = right | t = top | b = bottom
              <br /> amount: q1 = 1/4em | q2 = 1/2em | 1 = 1em <sup>1</sup> | 2
              = 2em <sup>1</sup> (2em) | 3 = 2em <sup>2</sup> (4em) | 4 = 2em{" "}
              <sup>4</sup> (8em) | 5 = 2em <sup>8</sup> (16em) | 0 = removes
              margin or padding
            </p>

            <p>
              <strong>Some examples: </strong>
              <code>.mtq1</code> = margin-top .25em; <code>.p1</code> = padding
              1em; <code>.m4</code> = margin 8em <code>.pr0</code> =
              padding-right: 0
            </p>
            ...
            <p>
              <strong>
                An example demonstrating vertical rhythm using bottom margins:
              </strong>
            </p>
            <div className="row">
              <div className="col-xs-2">
            ...
            <div className="row">
              <div className="col-xs-6">
                ...
                >
                  <p>
                    An example box of content that needs some spacing applied.
                  </p>
                </div>
              </div>
              <div className="col-xs-6">
                ...
                >
                  <p>
                    An example box of content that has been fixed using padding{" "}
                    <code>.p1</code>
                  </p>
                </div>
              </div>
            ...
            <p className="mt1">
              ...
              <br />
              When a specific distance is required that needs to remain constant
              regardless of the device, use these classes:{" "}
              ...
              spacer classes are created in 5px increments starting at 5px and
              ending at 100px.
            </p>
            <div className="highlight">
              <CodeBlock
