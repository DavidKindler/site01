          ...
          <div className="bs-docs-section">
            ...
            <article className="type-headings">
              ...
              <section className="overview">
                ...
                <p>
                  All headings use the "Lato" font family. Color values below
                  are <a href="/#less-overview">less</a> variables. Please check
                  the color palette for these values.
                </p>
              </section>
              ...
              <section className="highlight">
                <pre className="language-html">
                  <code>
                    ...
                    <p className="h1">h1. BaseCamp heading</p>
                    <h2>h2. BaseCamp heading</h2> or{" "}
                    <p className="h2">h2. BaseCamp heading</p>
                    <h3>h3. BaseCamp heading</h3> or{" "}
                    <p className="h3">h3. BaseCamp heading</p>
                    <h4>h4. BaseCamp heading</h4> or{" "}
                    <p className="h4">h4. BaseCamp heading</p>
                    <h5>h5. BaseCamp heading</h5> or{" "}
                    <p className="h5">h5. BaseCamp heading</p>
                    <h6>h6. BaseCamp heading</h6> or{" "}
                    <p className="h6">h6. BaseCamp heading</p>
                    <p className="huge">.huge BaseCamp Heading</p>
                  </code>
                </pre>
              </section>
            ...
            <article className="type-emphasis">
              ...
              <p>
                ...
                <code>&lt;small&gt;</code> tag to set text at 85% the size of
                the parent. Heading elements receive their own{" "}
              ...
              <p>
                ...
                <code>&lt;large&gt;</code> tag to set text at 115% the size of
                the parent.
              </p>
              <p>
                You may alternatively use an inline element with{" "}
              ...
              <div className="highlight">
                <pre className="language-html">
                  <code>
                    ...
                    <p>
                      <large>
                        This line of text is increased to 115% of parent
                        element.
                      </large>
                    </p>
                  </code>
              ...
              <div className="bs-callout bs-callout-info">
                ...
                <p>
                  ...
                  additional importance while <code>&lt;i&gt;</code> is mostly
          ...
          <div className="bs-docs-section">
            ...
            <article className="colors-main">
              ...
              <ul className="color-palette list-unstyled">
                <li>
                  <div className="color-thumbnail nxp-deep-orange" />
                </li>
                <li>
                  <div className="color-thumbnail nxp-orange" />
                </li>
                <li>
                  <div className="color-thumbnail nxp-green" />
                </li>
                <li>
                  <div className="color-thumbnail nxp-blue" />
                </li>
                <li>
                  <div className="color-thumbnail nxp-petrol-blue" />
                </li>
                <li>
                  <div className="color-thumbnail nxp-aqua" />
                </li>
                <li>
                  <div className="color-thumbnail nxp-olive-green" />
                </li>
                <li>
                  <div className="color-thumbnail nxp-apple-red" />
                </li>
                <li>
                  <div className="color-thumbnail nxp-absolute-black" />
                </li>
                <li>
                  <div className="color-thumbnail nxp-black" />
                </li>
                <li>
                  <div className="color-thumbnail nxp-charcoal" />
                </li>
                <li>
                  <div className="color-thumbnail nxp-gray-xdark" />
                </li>
                <li>
                  <div className="color-thumbnail nxp-gray-dark" />
                </li>
                <li>
                  <div className="color-thumbnail nxp-gray" />
                </li>
                <li>
                  <div className="color-thumbnail nxp-gray-medium" />
                </li>
                <li>
                  <div className="color-thumbnail nxp-gray-light" />
                </li>
                <li>
                  <div className="color-thumbnail nxp-gray-cool-light" />
                </li>
                <li>
                  <div className="color-thumbnail nxp-gray-xlight" />
                </li>
                <li>
                  <div className="color-thumbnail nxp-gray-xxlight" />
                </li>
                <li>
                  <div className="color-thumbnail white has-border" />
                </li>
              </ul>
            </article>
            ...
            <article className="colors-tints">
              ...
              <ul className="color-palette list-unstyled">
                ...
                <li>
                  <div className="color-thumbnail nxp-orange-66" />
                </li>
                <li>
                  <div className="color-thumbnail nxp-orange-33" />
                </li>
                <li>
                  <div className="color-thumbnail nxp-deep-orange" />
                </li>
                <li>
                  <div className="color-thumbnail nxp-deep-orange-66" />
                </li>
                <li>
                  <div className="color-thumbnail nxp-deep-orange-33" />
                </li>
                <li>
                  <div className="color-thumbnail nxp-pale-blue" />
                </li>
                <li>
                  <div className="color-thumbnail nxp-pale-blue-66" />
                </li>
                <li>
                  <div className="color-thumbnail nxp-pale-blue-33" />
                </li>
              </ul>
            </article>
          ...
          <div className="bs-docs-section">
            ...
            <article className="tables-centered">
              ...
              <div className="highlight">
                <pre className="language-html">
                  <code>
                    <table className="table table-centered">...</table>
                  </code>
                </pre>
              </div>
            </article>
            ...
            <article className="tables-light">
              ...
              <p>
                Add <code>.table-head-light</code> for the table header to have
                a white background color and thicker bottom border.
              </p>
              <div className="bc-example">
              ...
              <div className="highlight">
                <pre className="language-html">
                  <code>
                    <table className="table table-head-light">...</table>
                  </code>
                </pre>
              </div>
            </article>
            ...
            <article className="tables-responsive">
              ...
              <p>
                ...
                up to small devices (under 768px). When viewing on anything
                larger than 768px wide, you will not see any difference in these
                tables.
              </p>
              <div className="bc-example">
          ...
          <div className="bs-docs-section">
            ...
            <article className="forms-inline">
              ...
              <div className="bs-callout bs-callout-warning">
                ...
                <p>
                  ...
                  include a label for every input. For these inline forms, you
                  can hide the labels using the <code>.sr-only</code> class.
                </p>
              </div>
            ...
            <article className="forms-control">
              ...
              <section className="forms-control-inputs">
                ...
                <div className="bs-callout bs-callout-danger">
                  ...
                  <p>
                    Inputs will only be fully styled if their <code>type</code>{" "}
            ...
            <article className="input-groups">
              ...
              <p>
                ...
                <code>.input-group</code> with an{" "}
                <code>.input-group-addon</code> or <code>.input-group-btn</code>{" "}
              ...
              <section className="input-groups-sizing">
                ...
                <p>
                  ...
                  <code>input-group-sm</code> or <code>input-group-lg</code> to
                  the <code>.input-group</code> itself and contents within will
                  automatically resize—no need for repeating the form control
                  size classes on each element. No need to add a class for the
                  default size.
                </p>
                <div className="bc-example">
            ...
            <article className="forms-control-focus">
              ...
              <div className="bs-callout bs-callout-info">
                ...
                <p>
                  ...
                  documentation to demonstrate the <code>:focus</code> state on
                  a <code>.form-control</code>.
                </p>
              </div>
            </article>
            ...
            <article className="forms-control-disabled">
              ...
              <div className="bs-callout bs-callout-warning">
                ...
                <p>
                  ...
                  <code>&lt;a className="btn"&gt;</code> buttons, not their
            ...
            <article className="forms-control-validation">
              ...
              <div className="bs-callout bs-callout-warning">
                ...
                <p>
                  ...
                  <a href="./components#forms-input-groups">input groups</a>{" "}
                  with an add-on on the right. For inputs without labels, adjust
                  the <code>top</code>value. For input groups, adjust the{" "}
                  <code>right</code> value to an appropriate pixel value
          ...
          <div className="bs-docs-section">
            ...
            <div className="bc-example">
              <p>
                ...
                voluptatem impedit quis, id soluta? Ducimus magni eaque incidunt
                repellendus maiores quas unde vero eum, voluptates. Nam!
              </p>
            </div>
            <div className="highlight">
              <pre className="language-html">
            ...
            <article className="links-ctas">
              ...
              <p>
                ...
                the focus of the content that comes before. If there are
                multiple links, consider using basic links placed in a{" "}
                <code>&lt;ul className="list-unstyled"></code> or{" "}
                <code>&lt;ul className="list-inline"></code>.
              </p>
              <p>
                Standard call-to-action links are displayed as text links, and
                use a <code>cta</code> class. These differ from inline links,
                since they are not underlined and have a hover animation. These
                links also have a caret or <code>&gt;</code> symbol after the
                text. This icon changes on certain factors, such as if the link
                leaves the main site or references a PDF document.
              </p>
              <div className="bc-example">
          ...
          <div className="bs-docs-section">
            ...
            <article className="buttons-options">
              ...
              <p>
                ...
                importance they should all be the standard grey button color. If
                one action is most important, that button should be the orange
                button color with the others being button grey color.
              </p>
            ...
            <article className="buttons-disabled">
              ...
              <div className="bs-callout bs-callout-danger">
                <h4>Cross-browser compatibility</h4>
                <p>
                  If you add the <code>disabled</code> attribute to a{" "}
                  <code>&lt;button&gt;</code>, Internet Explorer 9 and below
                  will render text gray with a nasty text-shadow that we cannot
                  fix.
                </p>
              </div>
            </article>
                ...
                <pre className="language-html">
                  <code>
                    <input
                      ...
                      value="Submit Button"
                    />
                    <a className="btn btn-orange" href="#nofo">
                      Anchor Button
                    </a>
                    <a className="btn btn-icon-link" href="#nofo">
                      Link Button
                    </a>
                    <button className="btn btn-white" type="submit">
                      Button
          ...
          <div className="bs-docs-section">
            ...
            <article className="helper-classes-show-hide">
              ...
              <p>
                ...
                <a href="#helper-classes-floats">quick floats</a>. They are only
                available for block level toggling. They can also be used as
                mixins.
              </p>
              <p>
              ...
              <p>
                ...
                the visibility of an element, meaning its <code>display</code>{" "}
                is not modified and the element can still affect the flow of the
                document.
              </p>
              <div className="highlight">
                <pre className="language-html">
            ...
            <article className="helper-classes-spacers">
              ...
              <p>
                ...
                relative to the assigned font size. These should be used in most
                cases where spacing is needed.
              </p>
              <p>
                property: p = padding | m = margin
                <br /> direction: l = left | r = right | t = top | b = bottom
                <br /> amount: q1 = 1/4em | q2 = 1/2em | 1 = 1em <sup>1</sup> |
